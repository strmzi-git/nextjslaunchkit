...
const WorkCard = function ({ number, main, title, subtitle }: WorkCardProps) {
  return (
    <div
      className={`w-[100%] ${
        main &&
        " bg-white bg-opacity-[80%] shadow-md hover:scale-[1.025] min-w-[325px] backdrop-blur-[2px] hover:backdrop-blur-md"
    ...
    >
      ...
      <div className="">
        ...
        {subtitle && <p className="text-sm text-greyLight">{subtitle}</p>}
      </div>
    </div>
  );
};
